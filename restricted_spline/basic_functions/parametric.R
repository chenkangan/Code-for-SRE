...
Pareto =function(x,theta){
  # dn=gen(n)
  # dmu=gen(theta[1]*(1-(1+t1/theta[2])^(1-theta[1])))
  # mun=theta[1]*(1-(1+t1[l]/theta[2])^(1-theta[1]))
  # sum(dn*log(dmu))-mun
  theta[1]*(1-(1+x/theta[3])^(1-theta[2]))
}
Pareto1 =function(theta){
  dn=gen(n)
  lamn=(1-(1+t1[l]/theta[2])^(1-theta[1]))
  lam = (1-(1+t1/theta[2])^(1-theta[1]))
  a=n[l]/lamn
  dmu=gen(a*lam)
  mun=n[l]
  return(sum(dn*log(dmu))-mun)
...
para_con=function(xdat,i,n=1,theta=1){
  if(theta==1){
  ...
  if(i==1){
    ...
    summ =maxLik(Goel_Okumoto1, start =theta,constraints=list(ineqA=A1,ineqB=B1))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Goel_Okumoto2(summ$estimate,seq(0,t1[l],by=1))$func
  ...
  if(i==2){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(G_O1, start = theta,constraints=list(ineqA=A1,ineqB=B1))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=G_O2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ
    return(res)
  ...
  if(i==3){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Hossain_Dahiya1, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Hossain_Dahiya2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ    
    return(res)
  ...
  if(i==4){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Gompertz1, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Gompertz2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ
    return(res)
  ...
  if(i==5){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Pareto1, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Pareto2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ
    return(res)
  ...
  if(i==6){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Weibull1, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Weibull2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ
    return(res)
  ...
  if(i==7){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Yamada_Exp1, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Yamada_Exp2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ
    return(res)
  ...
  if(i==8){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Yamada_Raleigh1, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
    res$su=Yamada_Raleigh2(summ$estimate,seq(0,t1[l],by=1))$func
    res$MLE=summ$maximum
    res$summ=summ
    return(res)
  }
  ...
  # t=xdat
  # print(1)
  # summ1 =maxLik(Goel_Okumoto1, start = c(0.00035),constraints=list(ineqA=A1,ineqB=B1))
  # print(summ1)
  # lines(seq(0,t1[l],by=1),Goel_Okumoto2(summ1$estimate,seq(0,t1[l],by=1))$func,col='red')

  # summ2 =maxLik(G_O1, start = c(0.002),constraints=list(ineqA=A1,ineqB=B1))
  # print(2)
  # print(summ2)
  # lines(seq(0,t1[l],by=1),G_O2(summ2$estimate,seq(0,t1[l],by=1))$func,col='blue')
  # 
  # summ3 =maxLik(Hossain_Dahiya1, start = c(0.002,.2),constraints=list(ineqA=A,ineqB=B))
  # print(3)
  # print(summ3)
  # lines(seq(0,t1[l],by=1),Hossain_Dahiya2(summ3$estimate,seq(0,t1[l],by=1))$func,col='yellow')
  # 
  # print(4)
  # summ4 =maxLik(Gompertz1, start = c(0.001,0.9999),constraints=list(ineqA=A,ineqB=B))
  # print(summ4)
  # lines(seq(0,t1[l],by=1),Gompertz2(summ4$estimate,seq(0,t1[l],by=1))$func,col='purple')
  # 
  # summ5 =maxLik(Pareto1, start = c(0.002,.2),constraints=list(ineqA=A,ineqB=B))
  # print(5)
  # print(summ5)
  # lines(seq(0,t1[l],by=1),Pareto2(summ5$estimate,seq(0,t1[l],by=1))$func,col='green')
  # 
  # summ6 =maxLik(Weibull1, start = c(0.002,.2),constraints=list(ineqA=A,ineqB=B))
  # print(6)
  # print(summ6)
  # lines(seq(0,t1[l],by=1),Weibull2(summ6$estimate,seq(0,t1[l],by=1))$func,col='pink')
  # 
  # summ7 =maxLik(Yamada_Exp1, start = c(0.02,.002),constraints=list(ineqA=A,ineqB=B))
  # print(7)
  # print(summ7)
  # lines(seq(0,t1[l],by=1),Yamada_Exp2(summ7$estimate,seq(0,t1[l],by=1))$func,col='brown')
  # 
  # summ8 =maxLik(Yamada_Raleigh1, start = c(0.15,.00000015),constraints=list(ineqA=A,ineqB=B))
  # print(8)
  # print(summ8)
  # lines(seq(0,t[l],by=1),Yamada_Raleigh2(summ8$estimate,seq(0,t[l],by=1))$func,col='orange')
  # 
...
# A1=matrix(c(1),1,1)
# B1=matrix(-0.0001,1,1)
# # summ =nlm(Goel_Okumoto, theta = c(110,0.001), constraints=list(ineqA=A,ineqB=B),hessian=TRUE)
# plot(t0,n0)
# # summ =maxLik(Goel_Okumoto, start = c(110,0.002),constraints=list(ineqA=A,ineqB=B))
