...
Goel_Okumoto0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-exp(-theta[1]*t1)))
  mun=a*(1-exp(-theta[1]*t1[l]))
  return(sum(dn*log(dmu))-mun)
}
# Goel_Okumoto0(0.0001)
...
G_O0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-(1+theta[1]*t1)*exp(-theta[1]*t1)))
  mun=a*(1-(1+theta[1]*t1[l])*exp(-theta[1]*t1[l]))
  return(sum(dn*log(dmu))-mun)
}
# G_O0(0.0006)
...
Hossain_Dahiya0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-exp(-theta[1]*t1))/(1+theta[2]*exp(-theta[1]*t1)))
  mun=a*(1-exp(-theta[1]*t1[l]))/(1+theta[2]*exp(-theta[1]*t1[l]))
  sum(dn*log(dmu))-mun
}
...
Gompertz0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(theta[1]^(theta[2]^t1)))
  mun=a*(theta[1]^(theta[2]^t1[l]))
  sum(dn*log(dmu))-mun
}
...
Pareto0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-(1+t1/theta[2])^(-theta[1])))
  mun=a*(1-(1+t1[l]/theta[2])^(-theta[1]))
  sum(dn*log(dmu))-mun
}
...
Weibull0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-exp(-theta[1]*t1^theta[2])))
  mun=a*(1-exp(-theta[1]*t1[l]^theta[2]))
  sum(dn*log(dmu))-mun
}
...
Yamada_Exp0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-exp(-theta[1]*(1-exp(-theta[2]*t1)))))
  mun=a*(1-exp(-theta[1]*(1-exp(-theta[2]*t1[l]))))
  sum(dn*log(dmu))-mun
}
...
Yamada_Raleigh0 =function(theta){
  ...
  a=n[l]/lamn
  dmu=gen(a*(1-exp(-theta[1]*(1-exp(-theta[2]*t1^2/2)))))
  mun=a*(1-exp(-theta[1]*(1-exp(-theta[2]*t1[l]^2/2))))
  sum(dn*log(dmu))-mun
}
...
# Yamada_Raleigh0(c(1.228,0.00000007))
...
para_dis=function(xdat,i,n=1,theta=1){
  if(theta==1){
  ...
  if(i==1){
    ...
    summ =maxLik(Goel_Okumoto0, start =theta,constraints=list(ineqA=A1,ineqB=B1))
    res=new.env()
  ...
  if(i==2){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(G_O0, start = theta,constraints=list(ineqA=A1,ineqB=B1))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
  ...
  if(i==3){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Hossain_Dahiya0, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
  ...
  if(i==4){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Gompertz0, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
  ...
  if(i==5){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Pareto0, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
  ...
  if(i==6){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Weibull0, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
  ...
  if(i==7){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Yamada_Exp0, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
  ...
  if(i==8){
    if(theta==1){theta=list0[[i]]}
    summ =maxLik(Yamada_Raleigh0, start = theta,constraints=list(ineqA=A,ineqB=B))
    res=new.env()
    res$l=seq(0,t1[l],by=1)
